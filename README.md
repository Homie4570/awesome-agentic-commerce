...
- [LoneStarOracle](https://lonestaroracle.xyz) - 39 x402-paid data and AI services on Base covering crypto intelligence, financial markets, commodities, DeFi risk, smart contract security (Solidity/Rust/Move), and geopolitical risk. Sub-second cached responses, MCP server at mcp.lonestaroracle.xyz, /bin/zsh.02-.00 USDC per call.
